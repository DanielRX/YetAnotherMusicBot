...
import type {BaseGuildTextChannel, ColorResolvable} from 'discord.js';
...
export const execute = async(interaction: CustomInteraction): Promise<void> => {
    ...
    try {
        ...
        const output = await command.execute({guild: interaction.guild, sender: interaction.member, interaction, messages: await messages('en_gb'), params, guildId: interaction.guildId, channel: interaction.channel as BaseGuildTextChannel});
