...
export const options = [
    {type: 'string' as const, name: 'difficulty', description: '', required: false, choices: ['easy', 'medium', 'hard', 'all'], default: 'all'},
    {type: 'string' as const, name: 'question-type', description: '', required: false, choices: ['multiple', 'boolean', 'both'], default: 'both'}
];
