import type {Client, GuildMember, CommandInteraction, Message, TextBasedChannels, VoiceChannel, MessageEmbed, User} from 'discord.js';
...
export type CommandInput<T = any> = {params: T, interaction: CustomInteraction, message: MessageFunction, guildId: string};

export type Command = {deferred: boolean, execute: ({params, interaction, message}: CommandInput) => Promise<CommandReturn>, name: string, description: string, options?: OptionConfig[]};
