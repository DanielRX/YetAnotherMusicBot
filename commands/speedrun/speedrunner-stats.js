        ...
        if(!userRes.runners.length == 0) {
            ...
            for(let i = 1; i <= pbsRes.pbs.length; ++i) {
                pbEmbedArray.push(new MessageEmbed()
                    ...
                    .setAuthor(userRes.runners[0].name + '`s Speedrun Stats ',
                    ...
                    .setFooter('Powered by Splits.io! Run was submitted',
